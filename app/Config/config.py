...
EM_features = ['category1','similarity', 'haversine', 'Is_direction_match',
       'Is_name_number_match', 'Is_related_cat', 'Is_category_match',
       'Is_subcategory_match', 'Is_brand_match', 'Is_house_match',
       'is_phone_match', 'Is_email_match', 'Is_url_match', 'name_davies',
...
cat_columns = ['Is_direction_match','Is_name_number_match','Is_related_cat', 'Is_category_match',
       'Is_subcategory_match', 'Is_brand_match', 'Is_house_match',
       'is_phone_match', 'Is_email_match', 'Is_url_match','category1','Is_postal_match']
